...
const Coffee = () => {
  ...
  const isEspressoOnly = selectedNames.value === 'ESPRESSO'
          ...
          <div className="rounded-2xl bg-white p-8 border border-amber-100 shadow-sm h-full">
            ...
            {!loading && recipe && (
              <div className="flex flex-col animate-fadeIn">
                ...
                <div className="border-b border-amber-100 pb-5 mb-6">
            ...
            {recipe && (
              <div className="mt-8 border-t pt-6">
                ...
                >
                  ...
                  {loadingGenerate ? 'Adjust Brew...' : 'Adjust'}
